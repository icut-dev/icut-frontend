describe('Fazer uma agenda', () => {
  afterEach(() => {
    cy.findByTestId('open-model-setting', { timeout: 50000 }).click();
    cy.findByTestId('cancel-button', { timeout: 50000 }).click();
  });
  ...
  it('deve ser possível criar uma nova agenda', () => {
    ...
    cy.findByTestId('schedule-0', { timeout: 500000 }).click();
    cy.findByTestId('service-item-0', { timeout: 500000 }).click();
    cy.findByTestId('employee-0', { timeout: 500000 }).click();
    cy.findByTestId('time-0', { timeout: 500000 }).click();
